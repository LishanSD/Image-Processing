...
color_image = load_image('210339J_SrcImage.jpg') 
...
cv2.imwrite('210339J_OPImage_1,1.jpg', grayscale_img)
...
cv2.imwrite('210339J_OPImage_1,2.jpg', negative_img)
...
cv2.imwrite('210339J_OPImage_1,3.jpg', bright_img)
...
cv2.imwrite('210339J_OPImage_2,1.jpg', contrast_img)
...
cv2.imwrite('210339J_OPImage_2,2.jpg', four_bpp_img)
...
cv2.imwrite('210339J_OPImage_2,3.jpg', mirror_img)

# Save the entire subplot
pyplot.savefig('210339J_SubPlot.jpg')